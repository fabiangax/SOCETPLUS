 ...
 * @author Marco
 */
public class ModificarC extends javax.swing.JDialog {
    Connection c = ConexionSQLServer.Conectar();
    String[] datosCliente = new String[7];
    public ModificarC(String[] datosCliente, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
    ...
    public void insertar(Cliente objCliente){
        try{
           ...
           String sql = "Insert into CLIENTES values('"+objCliente.getMatricula()
                    ...
                    +"','"+objCliente.getTelefono()+"','"+objCliente.getEmail()
                    +"','"+objCliente.getDireccion()+"','"+objCliente.getEmpresa()+"')";
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        if(!(txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtTelefono.getText().isEmpty()) && (check6.isVisible() && check3.isVisible() && check4.isVisible() && check2.isVisible() && check7.isVisible() && check1.isVisible())){
            ...
            if(res==0){
                ...
                JOptionPane.showMessageDialog(null, "Registro de cliente actualizado correctamente", "Registro actualizado", JOptionPane.DEFAULT_OPTION);
            ...
            if(txtMatricula.getText().isEmpty() && txtNombre.getText().isEmpty() && txtApellido.getText().isEmpty() && txtTelefono.getText().isEmpty() && txtDireccion.getText().isEmpty() && txtEmpresa.getText().isEmpty() && txtEmail.getText().isEmpty()){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ModificarC dialog = new ModificarC(null,new javax.swing.JFrame(), true);
