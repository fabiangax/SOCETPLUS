 ...
 * @author Marco
 */
public class AgregarE extends javax.swing.JDialog {
    Connection c = ConexionSQLServer.Conectar();
    public AgregarE(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(puesto)))
                    .addComponent(jPanel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        if(check2.isVisible() && check3.isVisible() && check4.isVisible() && check5.isVisible() && check6.isVisible()){
            ...
            if(res==0){
                ...
                try{
                    if(resultado.next()){
                        ...
                        JOptionPane.showMessageDialog(null, "Registro de empleado completado correctamente", "Registro exitoso", JOptionPane.DEFAULT_OPTION);
                        this.dispose();
                    }
                }catch(SQLException e){
                    System.out.println(e);
            ...
            if(txtMatricula.getText().isEmpty() || txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtTelefono.getText().isEmpty() || txtDireccion.getText().isEmpty() || txtPuesto.getText().isEmpty()){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            AgregarE dialog = new AgregarE(new javax.swing.JFrame(), true);
