 ...
 * @author Marco
 */
public class ModificarE extends javax.swing.JDialog {
    Connection c = ConexionSQLServer.Conectar();
    String[] datosEmpleado = new String[6];
    public ModificarE(String[] datosEmpleado,java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
    ...
    public void insertar(Empleado objCliente){
        try{
           Statement ST = c.createStatement();
           String sql = "Insert into TRABAJADORES values('"+objCliente.getMatricula()
                    +"','"+objCliente.getNombre()+"','"+objCliente.getApellido()
                    +"','"+objCliente.getTelefono()
                    +"','"+objCliente.getDireccion()+"','"+objCliente.getPuesto()+"')";
    ...
    public void actualizar(Empleado objCliente){
        try{
           Statement ST = c.createStatement();
           String sql = "Update TRABAJADORES set nombre='"+objCliente.getNombre()
                   ...
                   +"' where IDTrabajador ='"+objCliente.getMatricula()+"'";
           ST.executeUpdate(sql);
        }catch(SQLException e){
            System.out.println(e);
        }
    ...
    private void initComponents() {
        ...
        Puesto.setFont(new java.awt.Font("Cambria", 0, 16)); // NOI18N
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
     if(!(txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtTelefono.getText().isEmpty() || txtDireccion.getText().isEmpty()) && (check6.isVisible() && check3.isVisible() && check4.isVisible() && check2.isVisible() && check7.isVisible())){
            ...
            if(res==0){
                ...
                JOptionPane.showMessageDialog(null, "Registro de empleado actualizado correctamente", "Registro actualizado", JOptionPane.DEFAULT_OPTION);
            ...
            if(txtMatricula.getText().isEmpty() && txtNombre.getText().isEmpty() && txtApellido.getText().isEmpty() && 
                    txtTelefono.getText().isEmpty() && txtDireccion.getText().isEmpty() && txtPuesto.getText().isEmpty()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ModificarE dialog = new ModificarE(null,new javax.swing.JFrame(), true);
