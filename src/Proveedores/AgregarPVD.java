 ...
 * @author Marco
 */
public class AgregarPVD extends javax.swing.JDialog {
    Connection c = ConexionSQLServer.Conectar();
    public AgregarPVD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
    ...
    public void insertar(Proveedor objCliente){
        try{
           Statement ST = c.createStatement();
           String sql = "Insert into PROVEEDORES values('"+objCliente.getMatricula()
                    +"','"+objCliente.getNombre()+"','"+objCliente.getTelefono()
                    +"','"+objCliente.getDireccion()+"','"+objCliente.getEmail()+"')";
           ST.executeUpdate(sql);
        }catch(SQLException e){
            System.out.println(e);
        }
    }
    public ResultSet buscar(Proveedor objCliente){
        try{
           Statement ST = c.createStatement();
           String sql = "Select * from PROVEEDORES where IDProveedor='"+objCliente.getMatricula()+"'";
    ...
    private void initComponents() {
        ...
        ad4.setText("e-mail inválido");
        jPanel2.add(ad4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, -1, -1));

        ad5.setForeground(new java.awt.Color(102, 102, 102));
        ad5.setText("Sólo números");
        jPanel2.add(ad5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, -1, -1));
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        if(check4.isVisible() && check5.isVisible() && check6.isVisible()){
            ...
            if(res==0){
                ...
                try{
                    if(resultado.next()){
                        ...
                        JOptionPane.showMessageDialog(null, "Registro de cliente proveedor correctamente", "Registro exitoso", JOptionPane.DEFAULT_OPTION);
                        this.dispose();
                    }
                }catch(SQLException e){
                    System.out.println(e);
            ...
            if(txtMatricula.getText().isEmpty() || txtNombre.getText().isEmpty() || txtDireccion.getText().isEmpty() || txtTelefono.getText().isEmpty() || txtEmail.getText().isEmpty()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarPVD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            AgregarPVD dialog = new AgregarPVD(new javax.swing.JFrame(), true);
