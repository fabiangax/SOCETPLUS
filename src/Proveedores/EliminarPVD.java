 ...
 * @author Marco
 */
public class EliminarPVD extends javax.swing.JDialog {
    Connection c = ConexionSQLServer.Conectar();
    String[] datosProveedor = new String[5];
    boolean valido=true;
    public EliminarPVD(String[] datosProveedor,java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
    ...
    public void eliminar(Proveedor objCliente){
        try{
           Statement ST = c.createStatement();
           String sql = "Delete from PROVEEDORES where IDProveedor='"+ objCliente.getMatricula() +"'";
    ...
    private void initComponents() {
        ...
        Aceptar.setDefaultCapable(false);
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        int res = JOptionPane.showConfirmDialog(null, "¿Está seguro de que desea eliminar a este proveedor?", "Confirmar", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        if(res==0){
            ...
            eliminar(objCliente);
            if(valido){
                JOptionPane.showMessageDialog(null, "El registro de proveedor se ha eliminado correctamente", "Registro eliminado", JOptionPane.DEFAULT_OPTION);
            }
            else{
                JOptionPane.showMessageDialog(null, "Este proveedor se está utilizando en otro registro, no se puede eliminar.", "Aviso", JOptionPane.DEFAULT_OPTION);
            }
            valido=true;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarPVD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            EliminarPVD dialog = new EliminarPVD(null,new javax.swing.JFrame(), true);
